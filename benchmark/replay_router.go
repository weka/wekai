...
func runRouterReplayInstance(
	...
	if err == nil {
		...
		// Mirrors the endpoint-router path in auto.go: both poster paths set
		// the floor, exactly as they both set outputRatio.
		poster.minOutputTokens = cfg.ReplayMinOutputTokens
